...
local WelcomeScreenPostProcessing = script:GetCustomProperty("WelcomeScreenPostProcessing"):WaitForObject()
local WelcomeScreenCamera = script:GetCustomProperty("WelcomeScreenCamera"):WaitForObject()
...
local function animateWelcomeScreen()
	...
	WelcomeScreenPostProcessing.visibility = Visibility.FORCE_ON
	LocalPlayer:SetOverrideCamera(WelcomeScreenCamera)
