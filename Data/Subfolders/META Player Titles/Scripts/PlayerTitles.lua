...
Module.Color = {
	RED = Color.FromStandardHex("#D32F2F"),
...
Module.titles = {
	{
		name = "Werithiel",
		prefix = "Werithiel",
		prefixColor = Module.Color.RED,
		icon = script:GetCustomProperty("GameCreator"),
		iconColor = Module.Color.RED,
		isModerator = true,
		extraWidth = 4,
		extraHeight = 4,
		playerMUIDs = {
			"aebc920024ad411d9b5ffee2e09ca124", -- Werithiel
		},
	},
...

	{
		...
		extraHeight = 4,
		playerMUIDs = {
			"1b13dea7a1a5468ea0d9d38f77269d7f", -- MattKaustik
			"9287ad93145f44d79da5d0ecee31df80", -- NyaAlchemi
			"84b064788d324156ad7fbdb6be82f5fc", -- SnoFlak
...

	{
		...
		playerMUIDs = {
			...
			"79ff4a2444a54e1d812940ff45f01fbe", -- JymbowSlice (https://www.youtube.com/c/jymbowslice)
		},
	},
}
